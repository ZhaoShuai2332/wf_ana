...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| logistic_regression | completed | multiclass | StratifiedGroupKFold | 0.8158440481128163 | 0.8077657284702641 | 0.8132148230863142 | 5 |  |
| random_forest | completed | multiclass | StratifiedGroupKFold | 0.9377851513894648 | 0.9310036871566156 | 0.9365619382494774 | 5 |  |
| knn | completed | multiclass | StratifiedGroupKFold | 0.7250103691414351 | 0.7140647558176755 | 0.7183892545552673 | 5 |  |
| xgboost | completed | multiclass | StratifiedGroupKFold | 0.9339140052536984 | 0.9279188921120776 | 0.9335060118111194 | 5 |  |

关键窗口结果：

| full_f1_macro | threshold_drop | threshold_f1_macro | critical_start_position | critical_end_position | critical_window |
| --- | --- | --- | --- | --- | --- |
| 0.9310036871566156 | 0.02 | 0.9110036871566156 | 1 | 7 | P1-P7 |
...
图像文件：`figure2_14727250_reproduction\outputs_full\plots\figure2_pseudo_payload_positions.png`
